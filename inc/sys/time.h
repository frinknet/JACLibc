...
#if defined(SYS_gettimeofday) && defined(__has_include)
	#if __has_include(<sys/syscall.h>)
...
#if defined(SYS_settimeofday) && defined(__has_include)
	#if __has_include(<sys/syscall.h>)
...
#if defined(SYS_getitimer) && defined(__has_include)
	#if __has_include(<sys/syscall.h>)
...
#if defined(SYS_setitimer) && defined(__has_include)
	#if __has_include(<sys/syscall.h>)
...
#if defined(SYS_utimes) && defined(__has_include)
	#if __has_include(<sys/syscall.h>)
...
#if defined(SYS_futimes) && defined(__has_include)
	#if __has_include(<sys/syscall.h>)
