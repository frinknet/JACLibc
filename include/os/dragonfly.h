/* (c) 2025 FRINKnet & Friends – MIT licence */
	...
	#define __jacl_os_statnorm  __dragonfly_statnorm
#undef __OS_CONFIG
#endif
...
#ifdef __OS_INIT
	static inline void __dragonfly_init(void) {
		/* noop */
	}
#undef __OS_INIT
#endif
...
static inline void __dragonfly_statnorm(const struct __dragonfly_stat *kbuf, struct stat *statbuf) {
