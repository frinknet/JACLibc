/**
 * PROTOCOLS CONSTANTS IMPORTED  //  last updated: 2026-05-01 20:59:32 UTC
 * https://www.iana.org/assignments/protocol-numbers/protocol-numbers-1.csv
 */

X(IPPROTO_HOPOPTS, 0, "HOPOPT", "IPv6 Hop-by-Hop Option")
...
X(IPPROTO_ROUTING, 43, "IPv6-Route", "Routing Header for IPv6")
X(IPPROTO_FRAGMENT, 44, "IPv6-Frag", "Fragment Header for IPv6")
...
X(IPPROTO_ICMPV6, 58, "IPv6-ICMP", "ICMP for IPv6")
X(IPPROTO_NONE, 59, "IPv6-NoNxt", "No Next Header for IPv6")
X(IPPROTO_DSTOPTS, 60, "IPv6-Opts", "Destination Options for IPv6")
...
X(IPPROTO_RAW, 255, "Reserved", "Reserved")
