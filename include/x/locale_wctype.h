...
X_LANG(TR,   L"0123456789", L"ABCDEFGHİIJKLMNOPQRSTUVWXYZ", L"abcdefghiıjklmnopqrstuvwxyz", L"", 27, 27, 0) // Turkish
...
X_LANG(WUU,  L"0123456789", L"一", L"龥", L"。，、？！：；「」『』（）《》", 0, 0, 16) // Wu Chinese
...
X_LANG(SV,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZÅÄÖ", L"abcdefghijklmnopqrstuvwxyzåäö", L"", 29, 29, 0) // Swedish
...
X_LANG(TW,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZ", L"abcdefghijklmnopqrstuvwxyz", L"", 26, 26, 0) // Twi
...
X_LANG(LO,   L"໐໑໒໓໔໕໖໗໘໙", L"ກ", L"ຮ", L"ໆ໌່້໊໋໌ໍ໎໏", 0, 0, 8) // Lao
...
X_LANG(DA,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ", L"abcdefghijklmnopqrstuvwxyzæøå", L"", 29, 29, 0) // Danish
X_LANG(BG,   L"0123456789", L"АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЬЮЯ", L"абвгдежзийклмнопрстуфхцчшщъьюя", L"", 30, 30, 0) // Bulgarian
X_LANG(HY,   L"0123456789", L"ԱԲԳԴԵԶԷԸԹԺԻԼԽԾԿՀՁՂՃՄՅՆՇՈՉՊՋՌՍՎՏՐՑՒՓՔՕՖ", L"աբգդեզէըթժիլխծկհձղճմյնշոչպջռսվտրցւփքօֆ", L"՛՝՞՜", 39, 39, 4) // Armenian
X_LANG(KON,  L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZ", L"abcdefghijklmnopqrstuvwxyz", L"", 26, 26, 0) // Kikongo
X_LANG(MN,   L"0123456789", L"АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯӨҮ", L"абвгдеёжзийклмнопрстуфхцчшщъыьэюяөү", L"", 35, 35, 0) // Mongolian
X_LANG(BO,   L"༠༡༢༣༤༥༦༧༨༩", L"ༀ", L"༼", L"་།༎༏༐", 0, 0, 0) // Tibetan
X_LANG(FI,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÅ", L"abcdefghijklmnopqrstuvwxyzäöå", L"", 29, 29, 0) // Finnish
...
X_LANG(FAT,  L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZƐƆ", L"abcdefghijklmnopqrstuvwxyzɛɔ", L"", 28, 28, 0) // Fante
X_LANG(LUO,  L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZ", L"abcdefghijklmnopqrstuvwxyz", L"", 26, 26, 0) // Luo
X_LANG(HR,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZČĆĐŠŽ", L"abcdefghijklmnopqrstuvwxyzčćđšž", L"", 30, 30, 0) // Croatian
X_LANG(SK,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZÁÄČĎÉÍĹĽŇÓÔŔŠŤÚÝŽ", L"abcdefghijklmnopqrstuvwxyzáäčďéíĺľňóôŕšťúýž", L"", 41, 41, 0) // Slovak
X_LANG(SQ,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZÇË", L"abcdefghijklmnopqrstuvwxyzçë", L"", 28, 28, 0) // Albanian
X_LANG(NB,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ", L"abcdefghijklmnopqrstuvwxyzæøå", L"", 29, 29, 0) // Norwegian Bokmål
X_LANG(KA,   L"0123456789", L"აბგდევზთიკლმნოპჟრსტუფქღყშჩცძწჭხჯჰ", L"", L"", 33, 0, 0) // Georgian
...
X_LANG(LT,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZĄČĘĖĮŠŲŪŽ", L"abcdefghijklmnopqrstuvwxyząčęėįšųūž", L"", 32, 32, 0) // Lithuanian
...
X_LANG(LV, L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZĀČĒĢĪĶĻŅŠŪŽ", L"abcdefghijklmnopqrstuvwxyzāčēģīķļņšūž", L"", 33, 33, 0) // Latvian
...
X_LANG(ET, L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZŠŽÕÄÖÜ", L"abcdefghijklmnopqrstuvwxyzšžõäöü", L"", 32, 32, 0) // Estonian
...
X_LANG(SYC,  L"܀܁܂܃܄܅܆܇܈܉", L"ܐܒܓܕܗܘܙܚܛܝܟܠܡܢܣܥܦܨܩܪܫܬ", L"", L"܀܁܂܃܄܅܆܇܈܉܊܋܌܍܎܏", 22, 0, 16) // Syriac
...
X_LANG(MT,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZĊĠĦŻ", L"abcdefghijklmnopqrstuvwxyzċġħż", L"", 30, 30, 0) // Maltese
...
X_LANG(IS,   L"0123456789", L"ABCDEFGHIJKLMNOPQRSTUVWXYZÁÐÉÍÓÚÝÞÆÖ", L"abcdefghijklmnopqrstuvwxyzáðéíóúýþæö", L"", 32, 32, 0) // Icelandic
