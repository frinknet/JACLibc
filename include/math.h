...
static double cbrt(double x)				 { return __builtin_cbrt(x); }
static double exp(double x)				 { return __builtin_exp(x); }
static double exp2(double x)				 { return __builtin_exp2(x); }
static double expm1(double x)			 { return __builtin_expm1(x); }
static double log(double x)				 { return __builtin_log(x); }
static double log2(double x)				 { return __builtin_log2(x); }
static double log10(double x)			 { return __builtin_log10(x); }
static double log1p(double x)			 { return __builtin_log1p(x); }
static double pow(double x,double y)			 { return __builtin_pow(x,y); }
static double hypot(double x,double y)		 { return __builtin_hypot(x,y); }
static double fmod(double x,double y)		 { return __builtin_fmod(x,y); }
static double remainder(double x,double y){ return __builtin_remainder(x,y); }
static double remquo(double x,double y,int*q){return __builtin_remquo(x,y,q);}
...
static double sinh(double x)				 { return __builtin_sinh(x); }
static double cosh(double x)				 { return __builtin_cosh(x); }
static double tanh(double x)				 { return __builtin_tanh(x); }
static double asinh(double x)			 { return __builtin_asinh(x); }
static double acosh(double x)			 { return __builtin_acosh(x); }
static double atanh(double x)			 { return __builtin_atanh(x); }
static double erf(double x)				 { return __builtin_erf(x); }
static double erfc(double x)				 { return __builtin_erfc(x); }
static double tgamma(double x)			 { return __builtin_tgamma(x); }
static double lgamma(double x)			 { return __builtin_lgamma(x); }
static double copysign(double x,double y){return __builtin_copysign(x,y);}
static double frexp(double x,int*e) { return __builtin_frexp(x,e); }
static double ldexp(double x,int e)	{ return __builtin_ldexp(x,e); }
static double modf(double x,double*i){ return __builtin_modf(x,i); }
