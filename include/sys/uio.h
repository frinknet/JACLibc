...
#if JACL_HAS_POSIX
static inline ssize_t readv(int fd, const struct iovec *iov, int iovcnt) { return syscall(SYS_readv, fd, iov, iovcnt); }
static inline ssize_t writev(int fd, const struct iovec *iov, int iovcnt) { return syscall(SYS_writev, fd, iov, iovcnt); }
static inline ssize_t preadv(int fd, const struct iovec *iov, int iovcnt, off_t offset) { return syscall(SYS_preadv, fd, iov, iovcnt, offset); }
static inline ssize_t pwritev(int fd, const struct iovec *iov, int iovcnt, off_t offset) { return syscall(SYS_pwritev, fd, iov, iovcnt, offset); }
#else
